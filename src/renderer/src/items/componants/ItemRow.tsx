...
export default function ItemRow(props: Props): JSX.Element {
  ...
  return (
    <tr className="bg-white border-b border-gray-200">
      ...
      <td className="px-6 py-4">{props.item.name}</td>
      <td className="px-6 py-4">{props.item.description}</td>
      <td className="px-6 py-4">{props.item.barcode}</td>
      <td className="px-6 py-4">{props.item.unit}</td>
